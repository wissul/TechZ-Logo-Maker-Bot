...
➤ Click /help Or The Button Below To Know How To Use Me...  My owner is @wisula4
"""
...
async def help(bot, message):
  await message.reply_photo("https://telegra.ph/file/c6c672ffe06f8a2313c08.jpg",caption=HELP,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Back", callback_data="start_menu")]]))
...
async def logo(bot, message):
  try:
    text = message.text.replace("logosq","").replace("/","").replace("@wisula4","").strip().upper()
